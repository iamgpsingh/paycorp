   ...
   <body>
      ...
      <div class="col-lg-12 ">
         ...
         <div class="well well-sm" >
            ...
            <p> Below IFrame is generating After the Initial Request to the new PCW Service.<br /> The corresponding Request is shown in the left side of the page You can add corresponding correct parameters for the form to check response from PCW.</p>
            <br />
         </div>
                  ...
                  <td>
                     <form action="payment_init.php" method="post" id="submitform">
                        <table class="table table-condensed" style="" >
                           <tr>
                              <td><b>Operation<span style="color: red">*</span></b></td>
                              <td><input type="text" readonly="readonly" name="operation" class="input-sm" value="PAYMENT_INIT" />  </td>
                           </tr>
                           <tr>
                              <td><b>Request Date<span style="color: red">*</span></b></td>
                              <td><input type="text" readonly="readonly" name="requestDate" class="input-sm" value="<?php echo date('Y-m-d H:i:s'); ?>" />  </td>
                           </tr>
                           <tr>
                              <td><b>Validate Only</b></td>
                              <td><input type="text" readonly="readonly" name="validateOnly" class="input-sm" value="FALSE" />  </td>
                           </tr>
                           <tr>
                              <td><b>Transaction Type<span style="color: red">*</span></b></td>
                              <td><input type="text" readonly="readonly" name="transactionType" class="input-sm" value="PURCHASE" />  </td>
                           </tr>
                           <tr>
                              <td><b>Tokenize</b></td>
                              <td><input type="text" readonly="readonly" name="tokenize" class="input-sm" value="FALSE" />  </td>
                           </tr>
                           <tr>
                              <td><b>Token Reference</b></td>
                              <td><input type="text" readonly="readonly" name="tokenReference" class="input-sm" value="tokenReference" />  </td>
                           </tr>
                           <tr>
                              <td><b>clientRef</b></td>
                              <td><input type="text" readonly="readonly" name="clientRef" class="input-sm" value="merchant_reference" />  </td>
                           </tr>
                           <tr>
                              <td><b>comment</b></td>
                              <td><input type="text" readonly="readonly" name="comment" class="input-sm" value="merchent_additional_data" />  </td>
                           </tr>
                           <tr>
                              <td><b>Payment Amount<span style="color: red">*</span></b></td>
                              <td><input type="text"name="paymentAmount" class="input-sm" value="1000" />  </td>
                           </tr>
                           <tr>
                              <td><b>Total Amount</b></td>
                              <td><input type="text" readonly="readonly" name="totalAmount" class="input-sm" value="0" />  </td>
                           </tr>
                           <tr>
                              <td><b>Service Fee Amount</b></td>
                              <td><input type="text" readonly="readonly" name="serviceFeeAmount" class="input-sm" value="0" />  </td>
                           </tr>
                           <tr>
                              <td><b>Currency<span style="color: red">*</span></b></td>
                              <td><input type="text" name="currency" class="input-sm" value="AUD" />  </td>
                           </tr>
                           <tr>
                              <td><b>Return Method</b></td>
                              <td><input type="text" readonly="readonly" name="returnMethod" class="input-sm" value="GET" />  </td>
                           </tr>
                           <tr>
                              <td><b>Redirect Url<span style="color: red">*</span></b></td>
                              <td><input type="text" readonly="readonly" name="returnUrl" class="input-sm" value="<?php echo $url ?>" />  </td>
                           </tr>
                           <tr>
                              <td><b></b></td>
                              <td><input type="submit" name="submit" class="btn btn-primary " value="Submit INIT Request" />  </td>
                           </tr>
                        </table>
                     </form>
                     <div class="" id="initresponsearea" >
                        <h6 style="color: maroon">Initial Response is for above request</h6>
